 ...
 * @version 1.0
 */
public class BankNN_optimization {
    ...
    public static void main(String[] args) {
        ...
        trainedIter.add(trainingIterations);
        ...
        try {
			PrintWriter output = new PrintWriter("BankNN.txt");
			output.println(results);
			
			PrintWriter train_accuracy = new PrintWriter("BankNN_train_accuracy.txt");
			PrintWriter train_recall = new PrintWriter ("BankNN_train_recall.txt");
			PrintWriter test_accuracy = new PrintWriter("BankNN_test_accuracy.txt");
			PrintWriter test_recall = new PrintWriter ("BankNN_test_recall.txt");
			train_accuracy.println("Iteration"+","+"Round"+","+"RHC"+","+","+"SA"+","+"GA");
			train_recall.println("Iteration"+","+"Round"+","+"RHC"+","+","+"SA"+","+"GA");
			test_accuracy.println("Iteration"+","+"Round"+","+"RHC"+","+","+"SA"+","+"GA");
			test_recall.println("Iteration"+","+"Round"+","+"RHC"+","+","+"SA"+","+"GA");
			
			for(int iter=0;iter<trainedIter.size();iter++){
	        	int iteration = trainedIter.get(iter);
	        	for(int round=0;round<5;round++){
				int k=iter*15+round;
				train_accuracy.println(iteration+","+round+","+TrainAccuracy.get(k)+","+TrainAccuracy.get(k+3)+","+TrainAccuracy.get(k+6));
				train_recall.println(iteration+","+round+","+TrainRecall.get(k)+","+TrainRecall.get(k+3)+","+TrainRecall.get(k+6));
				test_accuracy.println(iteration+","+round+","+TestAccuracy.get(k)+","+TestAccuracy.get(k+3)+","+TestAccuracy.get(k+6));
				test_recall.println(iteration+","+round+","+TestRecall.get(k)+","+TestRecall.get(k+3)+","+TestRecall.get(k+6));
			}	
			}
    ...
    private static Instance[] initializeInstancesTrain() {
        ...
        double[][][] attributes = new double[2260][][];
