 ...
 * @version 1.0
 */
public class NationalParkCrossOver implements CrossoverFunction {
    
    /**
     * The evaluation function
     */
    private NationalParkEvaluationFunction eval;
    
    /**
     * Make a new traveling salesman cross over
     * @param eval the evaluation function to use
     */
    public NationalParkCrossOver(NationalParkEvaluationFunction eval) {
        this.eval = eval;
    }
